...
builder.Services.AddDefaultIdentity<TravelAppUser>(options => options.SignIn.RequireConfirmedAccount = true)
...
builder.Services.AddTransient<IPastTravelsService, PastTravelsService>();
